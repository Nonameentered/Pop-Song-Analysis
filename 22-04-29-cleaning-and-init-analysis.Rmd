...
text(actualDiff + 4500, 1200, paste("Actual difference: ", round(actualDiff, 3)), srt = 90, cex = 0.9)
...
hist(trans_listeners, main="Histogram of Last.fm listeners (transformed)", xlab="Last.fm listeners ^ 1/3", ylab = "Frequency", cex.main = 1, cex.lab = 1, col = "blue")
```
...
interaction.plot(data1$region, data1$gender, data1$trans_listeners, type = 'b', lwd = 3, 
                 ...
                 main = "Interaction Plot of Region and Gender")
