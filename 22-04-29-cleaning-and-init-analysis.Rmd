...
### Box Cox transformation, GLM, and Backwards Stepwise Regression
```{r}
...
trans_listeners <- last_fm_listeners^pow1

# Perform backwards stepwise regression (we use a significance of 0.001 due to some initial p-values being extremely small)
...
mod2 <- lm(trans_listeners ~ gender + year + rank + region + artist_appearances + gender*year)
summary(mod2)
myResPlots2(mod2)
```
*Last two terms interesting; male and groups getting less popular with time?*
